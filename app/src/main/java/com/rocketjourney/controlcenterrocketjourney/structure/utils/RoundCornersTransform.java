package com.rocketjourney.controlcenterrocketjourney.structure.utils;
...
/**
 * Created by joseivanpenuelas on 2/22/18.
 */
...
public class RoundCornersTransform implements Transformation {
    ...
    public static int RJ_CORNER_RADIOUS = 24;
    public static int RJ_CORNER_RADIOUS_BRAND_CONNECTIONS = 24;
